...
@section("content")
<div class="container">
    @include("layouts.includes.breadcrumb", [ 'page' => __('main.reviews') ])
    <!--begin::Card-->
                ...
                <tbody>
                    @foreach ($reviews as $review)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url($review->image) ?? ''}}" target="_blank" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 ">
