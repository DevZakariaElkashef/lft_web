...
@elseif ($method == 'PUT')
    {!! Form::model($city, ['url' => [$action], 'method'=>$method , 'enctype'=>'multipart/form-data', 'files' => true]) !!}
@endif
    <div class="card-body">
        <div class="row">
            <!-- For loop this div -->
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    {!! Form::text('title[en]' , (isset($city) ? $city->getTranslations('title')['en'] : old('title[en]')) , ["class" => "form-control", "id" => "input_title", "placeholder"=> __('admin.en_title')]) !!}
                    @error('title.en')
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group">
                    ...
                    {!! Form::text('title[ar]' , (isset($city) ? $city->getTranslations('title')['ar'] : old('title[ar]')), ["class" => "form-control", "id" => "input_title", "placeholder"=> __('admin.ar_title')]) !!}
                    @error('title.ar')
                        <small class="aleart text-danger">{{ $message }}</small>
                    @enderror
                </div>
