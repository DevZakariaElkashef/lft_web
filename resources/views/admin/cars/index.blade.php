                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-3 mr-3">
                                        {{-- @can('cars.edit') --}}
                                        <a href="{{route('cars.edit',$car->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 ">
                                    ...
                                    <div class="col-md-3">
                                        {{-- @can('cars.destroy') --}}
                                            <button class="btn btn-icon btn-light btn-hover-danger btn-sm mx-3 delete" onclick="Delete('{{ $car->id }}')">
