...
<body>
    ...
    <button class="btn"
        style="background-color: #007bff;color: #fff;font-family: 'Cairo', sans-serif;  display: block;
            font-weight: 400;
            text-align: center;
            white-space: nowrap;
            ...
            cursor: pointer;
            margin: 1rem auto 0;"
        onclick="printDiv('printableArea')">طباعة الفاتورة</button>
    ...
    <button class="btn"
        ...
        cursor: pointer;
        margin: 1rem auto 0;"
        onclick="printDiv('printableAreaAttachments')">طباعة الملحقات</button>
    ...
    <div class="print" id="printableArea" style="width: 21cm;margin: auto;padding: 0 5mm;border: 1px solid #5d5d5d;">
        ...
        <div class="invoice" style="max-height: 21.7cm;overflow-y: hidden;">
            {{-- START HEADER --}}
            @include('admin.components.booking-invoices.printing.header', ['document_title' => __('admin.invoice')])
            {{-- END HEADER --}}
    ...
    <div class="printAttachments" id="printableAreaAttachments" style="width: 21cm;margin: auto;padding: 0 5mm;border: 1px solid #5d5d5d;">
        <!-- First page -->
        <div class="invoice">
            @include('admin.components.booking-invoices.printing.header', ['document_title' => __('admin.attachments')])
