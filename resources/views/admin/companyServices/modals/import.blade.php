    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="justify-content: space-between !important;">
                <a download="/company_services_sample.xlsx" type="button" class="btn btn-warning" href="{{ asset('/storage/samples/company_services_sample.xlsx') }}"> <i class="bi bi-download"></i>
