                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-3 mr-3">
                                        {{-- @can('superagents.edit') --}}
                                        <a href="{{route('superagents.edit',$superagent->id)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 ">
                                            <i class="fas fa-edit text-primary"></i>
                                        </a>
                                        {{-- @endcan --}}
                                    </div>
                                    <div class="col-md-3">
                                        {{-- @can('superagents.destroy') --}}
                                            <button class="btn btn-icon btn-light btn-hover-danger btn-sm mx-3 delete" onclick="Delete('{{ $superagent->id }}')">
