...
trait ResponseTrait
{
    ...
    public function returnResponseSuccessMessage($msg = "", $errNum = "0000")
    {
        return Response()->json([
            'status' => true,
            'errNum' => $errNum,
    ...
    public function saveLogActivity($attacher_id, $attacher_type, $log_id, $log_type, $container_status = 0)
    {
        ...
        $logActivity->attacher_type = $attacher_type;
        $logActivity->log_id = $log_id;
        $logActivity->log_type = $log_type;
        $logActivity->container_status = $container_status;
        $logActivity->save();
    }
}
